        ...
        <div className="row">
          ...
          <div className="col-lg-8 valign">
            <div className="content pt-0">
              ...
              <p>
                Chadrack Kyungu is a full-stack engineer with over 3 years of experience in the tech industry. I'm specialized in creating user-friendly, reliable and secure websites, web applications and mobile applications, while developing with an eye towards quality of the output and high standard code. Throughout my career, I have worked with some of the biggest Freelancing platform in the world like Upwork, as well as numerous smaller businesses and startup company like TNGSolutions for a year and half. I'm passionate about staying ahead of the curve when it comes to the latest technologies and trends, allowing me to deliver results that meet the highest standards of quality. I'm a strong track record when it comes to social responsibility, and i'm an active advocate for reducing the carbon footprint of the development process. I'm a driving force behind sustainable, energy-efficient projects and i'm passionate about using tech for good.
              </p>
