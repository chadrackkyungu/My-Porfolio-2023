        ...
        <div className="row">
          <div className="col-lg-3">
            <div className="item text-center md-mb50">
              <h5>  1. Planning </h5>
              <span className="color-font" mt-10>Research & Ideation</span>
              <p>
          ...
          <div className="col-lg-3">
            <div className="item text-center md-mb50">
              <h5> 2. Designing </h5>
              <span className="color-font" mt-10> Design & Prototyping</span>
              <p>
          ...
          <div className="col-lg-3">
            <div className="item text-center">
              <h5>3. Developing </h5>
              <span className="color-font" mt-10> Development & Testing  </span>
              <p>
          ...
          <div className="col-lg-3">
            <div className="item text-center">
              <h5>Launching</h5>
              <span className="color-font" mt-10>Deployment</span>
              <p>
