                    ...
                    <div className="col-lg-8 valign">
                        <div className="cont">
                            <h4 className="cd-headline clip">
                                Hello, my name is <span className="color-font">chadrack  </span> , and I'm an experienced full-stack developer who specializes in combining expert front-end and back-end solutions in order to bring powerful, dependable  and apps to life.
                                <span
