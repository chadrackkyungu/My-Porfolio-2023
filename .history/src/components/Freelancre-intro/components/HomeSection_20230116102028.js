                    ...
                    <div className="col-lg-8 valign">
                        <div className="cont">
                            <h4 className="cd-headline clip">
                                Hello 👋 , my name is <span className="color-font">Chadrack   </span>💻, and I'm an experienced full-stack <span className="color-font">JS</span> developer specialized in combining expert front-end and back-end solutions in order to bring quality,  dependable
                                <span
