            ...
            <div className="row justify-content-center">
              <div className="col-lg-8 col-md-10">
                <div className="sec-head  text-center">
                  <h6 className="wow fadeIn" data-wow-delay=".5s"> What clients are says about me </h6>
            ...
            <div className="col-lg-12">
              ...
              >
                <div className="item">
                  ...
                  <span> I would highly recommend Vie Digital. I worked with the team on an animation for our ‘Click &amp; Collect’ service. </span>
                </div>
                <div className="item">
                  <div className="info valign">
                    <div className="cont">
                  ...
                  <div className="info valign">
                    <div className="cont">
                      <div className="author">
                        ...
                        <h6 className="author-name color-font">  APatrick Nkulu </h6>
                      </div>
                    </div>
                  </div>
                  <span> I would highly recommend Vie Digital. I worked with the team on an animation for our ‘Click &amp; Collect’ service.  </span>
