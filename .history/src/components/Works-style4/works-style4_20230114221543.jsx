          ...
          <div className="gallery full-width">
            ...
            >
              <div className="item-img">
                ...
                <div className="tags">
                  <span>
                    <Link href="/works2/works2-dark">Github</Link>
                  </span>
                  <span>
                    <Link href="/works2/works2-dark">View details</Link>
                  </span>
                </div>
              </div>
            </div>
            ...
            >
              <div className="item-img">
                ...
                <div className="tags">
                  <span>
                    <Link href="https://github.com/chadrackkyungu">Get it on Github</Link>
                  </span>
                  <span>
                    <Link href="/works2/works2-dark">View project details</Link>
                  </span>
                </div>
              </div>
            </div>
